({
  doInit: function(component, event, helper) {
    var action = component.get("c.fetchSoldPaan");
    ...
    action.setCallback(
      ...
      function(response) {
        ...
        component.set("v.soldList", responseValue);
      },
      "SUCCESS"
    );
  ...
  onScrollX: function(component, event, helper) {
    ...
    var elmnt = document.getElementById("soldListOfPaan");
    ...
    if (totalHeight - position <= 300) {
      ...
      if (!isLoading) {
        ...
        var action = component.get("c.getPaanList");
        action.setParams({
          dLimit: 5,
          dOffset: offset
        });
        action.setCallback(this, function(response) {
          ...
          var data = component.get("v.soldList");
          var newData = data.concat(responseValue);
          component.set("v.soldList", newData);
